...
theDiv === null || theDiv === void 0 ? void 0 : theDiv.appendChild(instructionsContainer);
...
function determineWinner(player, computer) {
    if (player === computer) {
    ...
    else if ((player === "Sten" && computer === "Sax") ||
        ...
        theDiv === null || theDiv === void 0 ? void 0 : theDiv.appendChild(scorePComputer);
        return "Datorn vann!";
    }
}
...
function createHtmlWinner(result, player, computer) {
    ...
    // Lägg till i DOM:en
    theDiv === null || theDiv === void 0 ? void 0 : theDiv.appendChild(resultContainer);
}
